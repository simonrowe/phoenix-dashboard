...
public class CloudControllerClientTest {
    ...
    public void testProcessFirstPage() throws Exception {
        ProcessCloudControllerResponse response = client.process("http://localhost:10001/v3/processes?page=1&per_page=2", ProcessCloudControllerResponse.class);
    ...
    public void testProcessSecondPage() throws Exception {
        ProcessCloudControllerResponse response = client.process("http://localhost:10001/v3/processes?page=2&per_page=2", ProcessCloudControllerResponse.class);
        assertNotNull(response);
    ...
    @Test
    public void testServicesFirstPage() throws Exception {
        ServiceCloudControllerResponse response = client.process("http://localhost:10001/v3/service_instances?page=1&per_page=2", ServiceCloudControllerResponse.class);
        assertNotNull(response);
    ...
    @Test
    public void testServicesSecondPage() throws Exception {
        ServiceCloudControllerResponse response = client.process("http://localhost:10001/v3/service_instances?page=2&per_page=2", ServiceCloudControllerResponse.class);
        assertNotNull(response);
        assertNull(response.getNextPageUri());
